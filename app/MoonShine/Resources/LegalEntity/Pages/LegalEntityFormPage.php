...
/**
 * @extends FormPage<LegalEntityResource>
 */
                            ...
                            Grid::make([
                                Column::make([
                                    ...
                                    Box::make([
                                        ...
                                        Text::make('Юридический адрес', 'legal_address')->unescape()->locked(),
                                        ...
                                        Text::make(__('КПП'), 'kpp')->unescape()->locked(),
                                        Text::make(__('ОГРН'), 'ogrn')->unescape()->locked(),
                                        Text::make(__('Руководитель (должность, ФИО)'), 'director')->unescape()->locked(),
                                        Text::make(__('Главный бухгалтер'), 'accountant')->unescape()->locked(),
                                        Text::make(__('Лицо, уполномоченное подписывать договоры по доверенности'), 'person_contract')->unescape()->locked(),
    ...
    protected function rules(DataWrapperContract $item): array
    {
        return [
            'email' => [
                ...
                'required',
                'email',
                Rule::unique('legal_entities')->ignore($item->email, 'email'),
            ],
            'phone' => [
