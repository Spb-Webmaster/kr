...
/**
 * @extends IndexPage<ProductTagResource>
 */
class ProductTagIndexPage extends IndexPage
{
        ...
        return parent::buttons()
            ->add(
                ActionButton::make('Clone')
                    ...
                    ->method('duplicateRow')
                    ->withConfirm('Clone this row?', 'Сохраняется без поля "img", исправьте это вручную.')
            );
    }
