...
<x-seo.meta
    title="Юридическое лицо | Регистрация поставщиков услуг"
    description="Юридическое лицо | Регистрация поставщиков услуг"
    keywords="Юридическое лицо | Регистрация поставщиков услуг"
/>
                        ...
                        <div class="window_white__padding">
                            ...
                            >
                                ...
                                <div class="cu_row_50">
                                    <div class="cu__col">
                                        <x-form.form-input
                                            name="legal_address"
                                            type="text"
                                            :label="config('site.constants.legal_entity_address')"
                                ...
                                <div class="cu_row_50">
                                    <div class="cu__col">
                                        <x-form.form-input
                                            name="kpp"
                                            type="text"
                                            :label="config('site.constants.kpp')"
                                            value="{{ (old('kpp'))?:'' }}"
                                        />
                                    </div>
                                    <div class="cu__col">
                                        <x-form.form-input
                                            name="ogrn"
                                            type="text"
                                            :label="config('site.constants.ogrn')"
                                            value="{{ (old('ogrn'))?:'' }}"
                                        />
                                    </div>
                                </div>
                                <div class="cu_row_50">
                                    <div class="cu__col">
                                        <x-form.form-input
                                            name="director"
                                            type="text"
                                            :label="config('site.constants.director')"
                                            value="{{ (old('director'))?:'' }}"
                                        />
                                    </div>
                                    <div class="cu__col">
                                        <x-form.form-input
                                            name="accountant"
                                            type="text"
                                            :label="config('site.constants.accountant')"
                                ...
                                <x-form.form-input
                                    ...
                                    type="text"
                                    :label="config('site.constants.person_contract')"
                                    value="{{ (old('person_contract'))?:'' }}"
                                />
                                <x-form.form-input
                                    name="bank"
                                    type="text"
