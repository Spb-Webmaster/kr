...
@section('preheader', 'Ваш аккаунт создан. Логин и пароль для входа внутри письма.')
@section('recipient_email', $user['email'])
@section('send_reason', 'регистрации аккаунта')
...
@section('content')
    ...
    <tr>
        <td class="hero-pad" style="padding:40px 40px 32px 40px;background-color:#fff7f7;" align="left">
            ...
            <div style="font-family:Arial, Helvetica, sans-serif;font-size:15px;line-height:22px;color:#6b6b73;">
                Всё готово &mdash; ниже данные для входа в личный кабинет.
            </div>
        </td>
    </tr>
                ...
                <tr>
                    <td class="cred-pad" style="padding:20px 24px;" align="left">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td width="90" valign="top" style="font-family:Arial, Helvetica, sans-serif;font-size:13px;line-height:22px;color:#8a8a92;padding:4px 0;">Логин</td>
                            ...
                            <tr>
                                <td colspan="2" style="font-size:0;line-height:0;padding:6px 0;">
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td width="90" valign="top" style="font-family:Arial, Helvetica, sans-serif;font-size:13px;line-height:22px;color:#8a8a92;padding:4px 0;">Пароль</td>
                                <td valign="top" style="font-family:'Courier New', Courier, monospace;font-size:16px;line-height:22px;color:#1a1a1a;font-weight:bold;padding:4px 0;letter-spacing:1px;">{{ $user['password'] }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center" style="border-radius:4px;background-color:#e30613;">
                        <!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ config('app.app_url') }}/login" style="height:48px;v-text-anchor:middle;width:200px;" arcsize="9%" strokecolor="#e30613" fillcolor="#e30613">
                            <w:anchorlock/>
                            <center style="color:#ffffff;font-family:Arial, Helvetica, sans-serif;font-size:15px;font-weight:bold;">Войти на сайт</center>
                        </v:roundrect>
                        <![endif]-->
                        <!--[if !mso]><!-- -->
                        <a href="{{ config('app.app_url') }}/login" class="btn-a" target="_blank" style="background-color:#e30613;border:1px solid #e30613;border-radius:4px;color:#ffffff;display:inline-block;font-family:Arial, Helvetica, sans-serif;font-size:15px;font-weight:bold;line-height:48px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;mso-hide:all;">Войти на сайт &rarr;</a>
                        <!--<![endif]-->
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td class="px-40" style="padding:4px 40px 24px 40px;font-family:Arial, Helvetica, sans-serif;font-size:13px;line-height:20px;color:#8a8a92;" align="left">
            ...
            <a href="{{ config('app.app_url') }}/login" target="_blank" style="color:#e30613;text-decoration:none;font-weight:bold;word-break:break-all;">{{ config('app.app_url') }}/login</a>
        </td>
    </tr>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#fffaf0;border-left:3px solid #f0b429;border-radius:4px;">
                <tr>
                    <td style="padding:14px 18px;font-family:Arial, Helvetica, sans-serif;font-size:13px;line-height:20px;color:#5a4a1f;" align="left">
                        В целях безопасности рекомендуем сменить пароль после первого входа в личный кабинет.
                    </td>
                </tr>
            </table>
        </td>
