...
@section('preheader', 'Ваш аккаунт поставщика создан. Логин и пароль для входа внутри письма.')
    ...
    <tr>
        <td class="hero-pad" style="padding:40px 40px 32px 40px;background-color:#fff7f7;" align="left">
            ...
            <div style="font-family:Arial, Helvetica, sans-serif;font-size:15px;line-height:22px;color:#6b6b73;">
                Ваша заявка на регистрацию в качестве юридического лица принята. Ниже данные вашего аккаунта.
            </div>
        </td>
    </tr>
